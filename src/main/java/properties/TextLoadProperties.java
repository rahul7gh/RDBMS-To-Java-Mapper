...
public class TextLoadProperties implements LoadPropertiesIface {
	...
	public static void checkProps(YamlProperties yamlProperties, TextProperties textProperties) {
		...
		if (System.getProperty("param.database.port") == null) {
			log.warn("No Port Provided! Assuming default port: "+ selectedDatabase.getPort() +" for the " + textProperties.getParam_database_type()
					+ " .");
